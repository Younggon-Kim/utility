...
/**
 * This example describes how to set timeout with given time.
...
public:
    ...
    void run(std::chrono::milliseconds timeout) {
        ...
        timer_.setTimeout(std::bind(&Monitor::onExpired, this), timeout);
...
int main(int argc, char **argv) {
    ...
    monitor.run(std::chrono::milliseconds(1000 * 5));
